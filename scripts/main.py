import argparse
from preprocessing.wiki_dump_spacy_processor import wiki_dump_spacy_processor
from utils import log_section
from weak_annotation.annotation_with_entity_pairs.EntityPairAnnotator import EntityPairsAnnotator
from weak_annotation.annotation_with_patterns.PatternSearch import PatternSearch
import sys
import os
import logging
